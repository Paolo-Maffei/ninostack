\hypertarget{libSSI_8h}{
\section{/home/juha/ns\_\-1\_\-1\_\-0/subversion/nanostack/Tools/lib\-SSI/lib\-SSI.h File Reference}
\label{libSSI_8h}\index{/home/juha/ns_1_1_0/subversion/nanostack/Tools/libSSI/libSSI.h@{/home/juha/ns\_\-1\_\-1\_\-0/subversion/nanostack/Tools/libSSI/libSSI.h}}
}
The \hyperlink{libSSI_8h}{lib\-SSI.h} header file. 
...
\item 
\#define \hyperlink{libSSI_8h_e362eb21fe1afcb376407cb7811faf38}{GET\_\-PACKET\_\-TYPE}(x)~(x\mbox{[}1\mbox{]} \& 0x\-DF)
\end{CompactItemize}
\subsection*{Functions}
\begin{CompactItemize}
\item 
unsigned char $\ast$ \hyperlink{libSSI_8h_0435f803022b0062821d0207687d4f9f}{lib\-SSI\_\-create\_\-query} (unsigned char $\ast$addr)
\item 
int \hyperlink{libSSI_8h_ca3656207563de659d47ddff9ebe0a8e}{lib\-SSI\_\-parse\_\-answer} (unsigned char $\ast$buffer, unsigned char $\ast$address, unsigned char $\ast$version, unsigned char $\ast$buffer\_\-sz, unsigned char $\ast$msg\_\-delay, unsigned char $\ast$reserved)
\item 
unsigned char $\ast$ \hyperlink{libSSI_8h_e999b15a2e684c22572024514984f1d8}{lib\-SSI\_\-sensor\_\-discovery} (unsigned char $\ast$addr)
\item 
int \hyperlink{libSSI_8h_b56ec703ccbb2a47be371d0cae4644d8}{lib\-SSI\_\-data\_\-request} (unsigned char $\ast$req\_\-buffer, unsigned char $\ast$addr, uint16\_\-t $\ast$sensor\_\-ids, unsigned char $\ast$sensor\_\-count)
\item 
int \hyperlink{libSSI_8h_e7c8b1d16adac2bfff94ebf31b0ef33e}{lib\-SSI\_\-parse\_\-data\_\-response} (unsigned char $\ast$buffer, unsigned char $\ast$address, uint16\_\-t $\ast$sensor\_\-ids, uint32\_\-t $\ast$sensor\_\-values, int buffer\_\-len)
\item 
uint32\_\-t $\ast$ \hyperlink{libSSI_8h_fc6b2bb869ae4b6ad4f20e3e6778a7dc}{lib\-SSI\_\-get\_\-response\_\-data} (unsigned char $\ast$buffer, unsigned char $\ast$address, uint16\_\-t $\ast$sensor\_\-id, int value\_\-sz)
\item 
unsigned char $\ast$ \hyperlink{libSSI_8h_214a1969cca3bc210b5253b2f7ded844}{lib\-SSI\_\-create\_\-observer} (unsigned char $\ast$address, uint16\_\-t interval, int8\_\-t multiplier, uint8\_\-t count, uint8\_\-t length, uint32\_\-t threshold, uint16\_\-t $\ast$sensor\_\-ids, uint8\_\-t sensors)
\item 
int \hyperlink{libSSI_8h_b06e5daae7a5fd90d47d8cc7e1d5e32f}{lib\-SSI\_\-parse\_\-obs\_\-created} (unsigned char $\ast$buffer, unsigned char $\ast$address, unsigned char $\ast$observer\_\-id)
\item 
int \hyperlink{libSSI_8h_6bf19d62c9f06e867f374679daeb6e9d}{lib\-SSI\_\-parse\_\-obs\_\-finished} (unsigned char $\ast$buffer, unsigned char $\ast$address, unsigned char $\ast$observer\_\-id)
\item 
unsigned char $\ast$ \hyperlink{libSSI_8h_41ceb13f04235e6d6857d85de8958d5e}{lib\-SSI\_\-create\_\-delete\_\-observer} (unsigned char $\ast$address, unsigned char $\ast$observer\_\-id)
\item 
unsigned char $\ast$ \hyperlink{libSSI_8h_7908eaa90dc178dee5859f6e8c79bed7}{lib\-SSI\_\-create\_\-short\_\-error} (unsigned char $\ast$address, unsigned char errorcode)
\item 
uint16\_\-t $\ast$ \hyperlink{libSSI_8h_1cf7f1865b83c4db022c1dccc92bb494}{lib\-SSI\_\-parse\_\-error\_\-packet} (unsigned char $\ast$buffer, unsigned char $\ast$address, unsigned char $\ast$errorcode, unsigned char packet\_\-size)
\item 
int \hyperlink{libSSI_8h_a09708359b3dd973984887e07d7e9cb2}{lib\-SSI\_\-parse\_\-disc\_\-reply} (unsigned char $\ast$buffer, unsigned char $\ast$address, uint16\_\-t packet\_\-size, unsigned char $\ast$sensors, struct sensor\_\-description\_\-t $\ast$sensor\_\-desc)
\end{CompactItemize}
...
\hypertarget{libSSI_8h_e362eb21fe1afcb376407cb7811faf38}{
\index{libSSI.h@{lib\-SSI.h}!GET_PACKET_TYPE@{GET\_\-PACKET\_\-TYPE}}
\index{GET_PACKET_TYPE@{GET\_\-PACKET\_\-TYPE}!libSSI.h@{lib\-SSI.h}}
\subsubsection[GET\_\-PACKET\_\-TYPE]{\setlength{\rightskip}{0pt plus 5cm}\#define GET\_\-PACKET\_\-TYPE(x)~(x\mbox{[}1\mbox{]} \& 0x\-DF)}}
\label{libSSI_8h_e362eb21fe1afcb376407cb7811faf38}


GET\_\-PACKET\_\-TYPE Get the type of the SSI packet.

\begin{Desc}
\item[Parameters:]
\begin{description}
\item[{\em buffer}]The SSI packet. \end{description}
\end{Desc}
\begin{Desc}
\item[Returns:]The packet type as enumerated value.\end{Desc}
NOTE: To be precise the buffer argument does not have to be the whole packet the first two bytes are enough (although it is usually far more convenient to pass a pointer to the whole packet. NOTE: This macro is just a simple wrapper which enables one to mask the two different ways of marking the packet types (small caps or capital letters). 

\subsection{Function Documentation}
\hypertarget{libSSI_8h_41ceb13f04235e6d6857d85de8958d5e}{
\index{libSSI.h@{lib\-SSI.h}!libSSI_create_delete_observer@{libSSI\_\-create\_\-delete\_\-observer}}
\index{libSSI_create_delete_observer@{libSSI\_\-create\_\-delete\_\-observer}!libSSI.h@{lib\-SSI.h}}
\subsubsection[libSSI\_\-create\_\-delete\_\-observer]{\setlength{\rightskip}{0pt plus 5cm}unsigned char$\ast$ lib\-SSI\_\-create\_\-delete\_\-observer (unsigned char $\ast$ {\em address}, unsigned char $\ast$ {\em observer\_\-id})}}
\label{libSSI_8h_41ceb13f04235e6d6857d85de8958d5e}


lib\-SSI\_\-create\_\-delete\_\-observer Create an SSI Delete Observer packet (type 'K').

\begin{Desc}
\item[Parameters:]
\begin{description}
\item[{\em address}]a pointer to an unsigned char containing the sensor address (address == NULL -$>$'?' for wildcard as usual) \item[{\em observer\_\-id}]a pointer to an unsigned char where the sensor ID is stored \end{description}
\end{Desc}
\begin{Desc}
\item[Returns:]The function returns a pointer to a unsigned char array which will contain the three byte packet\end{Desc}
NOTE: The user must free the memory allocated to the pointer that this function returns. \hypertarget{libSSI_8h_214a1969cca3bc210b5253b2f7ded844}{
\index{libSSI.h@{lib\-SSI.h}!libSSI_create_observer@{libSSI\_\-create\_\-observer}}
\index{libSSI_create_observer@{libSSI\_\-create\_\-observer}!libSSI.h@{lib\-SSI.h}}
...
\label{libSSI_8h_214a1969cca3bc210b5253b2f7ded844}
...
NOTE: The user \_\-must\_\- take care of the freeing of the memory address that this function returns. \hypertarget{libSSI_8h_0435f803022b0062821d0207687d4f9f}{
\index{libSSI.h@{lib\-SSI.h}!libSSI_create_query@{libSSI\_\-create\_\-query}}
\index{libSSI_create_query@{libSSI\_\-create\_\-query}!libSSI.h@{lib\-SSI.h}}
...
\label{libSSI_8h_0435f803022b0062821d0207687d4f9f}
...
NOTE: The user \_\-must\_\- take care of the freeing of the memory address that this function returns. \hypertarget{libSSI_8h_7908eaa90dc178dee5859f6e8c79bed7}{
\index{libSSI.h@{lib\-SSI.h}!libSSI_create_short_error@{libSSI\_\-create\_\-short\_\-error}}
\index{libSSI_create_short_error@{libSSI\_\-create\_\-short\_\-error}!libSSI.h@{lib\-SSI.h}}
...
\label{libSSI_8h_7908eaa90dc178dee5859f6e8c79bed7}
...
\hypertarget{libSSI_8h_b56ec703ccbb2a47be371d0cae4644d8}{
\index{libSSI.h@{lib\-SSI.h}!libSSI_data_request@{libSSI\_\-data\_\-request}}
\index{libSSI_data_request@{libSSI\_\-data\_\-request}!libSSI.h@{lib\-SSI.h}}
...
\label{libSSI_8h_b56ec703ccbb2a47be371d0cae4644d8}
...
NOTE: The user \_\-must\_\- take care of the freeing of the memory address that this function returns. \hypertarget{libSSI_8h_fc6b2bb869ae4b6ad4f20e3e6778a7dc}{
\index{libSSI.h@{lib\-SSI.h}!libSSI_get_response_data@{libSSI\_\-get\_\-response\_\-data}}
\index{libSSI_get_response_data@{libSSI\_\-get\_\-response\_\-data}!libSSI.h@{lib\-SSI.h}}
...
\label{libSSI_8h_fc6b2bb869ae4b6ad4f20e3e6778a7dc}
...
NOTE: This function can be used to parse ONLY Sensor Data Response packet of type 'M' ! NOTE: The user \_\-must\_\- take care of the freeing of the memory address that this function returns and the memory range that is allocated for the variablee $\ast$address and $\ast$sensor\_\-id. \hypertarget{libSSI_8h_ca3656207563de659d47ddff9ebe0a8e}{
\index{libSSI.h@{lib\-SSI.h}!libSSI_parse_answer@{libSSI\_\-parse\_\-answer}}
\index{libSSI_parse_answer@{libSSI\_\-parse\_\-answer}!libSSI.h@{lib\-SSI.h}}
...
\label{libSSI_8h_ca3656207563de659d47ddff9ebe0a8e}
...
NOTE: The user \_\-must\_\- take care of the freeing of the memory addresses that this function allocates for variables $\ast$address, $\ast$version, $\ast$buffer\_\-sz, $\ast$msg\_\-delay and $\ast$reserved. \hypertarget{libSSI_8h_e7c8b1d16adac2bfff94ebf31b0ef33e}{
\index{libSSI.h@{lib\-SSI.h}!libSSI_parse_data_response@{libSSI\_\-parse\_\-data\_\-response}}
\index{libSSI_parse_data_response@{libSSI\_\-parse\_\-data\_\-response}!libSSI.h@{lib\-SSI.h}}
...
\label{libSSI_8h_e7c8b1d16adac2bfff94ebf31b0ef33e}
...
NOTE: This function can be used to parse ONLY Sensor Data Response packet of type 'V' ! NOTE: The ith element of sensor\_\-values contains the data associated to the sensor at the ith element of the sensor\_\-ids \hypertarget{libSSI_8h_a09708359b3dd973984887e07d7e9cb2}{
\index{libSSI.h@{lib\-SSI.h}!libSSI_parse_disc_reply@{libSSI\_\-parse\_\-disc\_\-reply}}
\index{libSSI_parse_disc_reply@{libSSI\_\-parse\_\-disc\_\-reply}!libSSI.h@{lib\-SSI.h}}
...
\label{libSSI_8h_a09708359b3dd973984887e07d7e9cb2}
...
NOTE: The user must take care of the freeing of the memory allocated for the returned struct. This memory is allocated within this function so the calling function does not have to do that. \hypertarget{libSSI_8h_1cf7f1865b83c4db022c1dccc92bb494}{
\index{libSSI.h@{lib\-SSI.h}!libSSI_parse_error_packet@{libSSI\_\-parse\_\-error\_\-packet}}
\index{libSSI_parse_error_packet@{libSSI\_\-parse\_\-error\_\-packet}!libSSI.h@{lib\-SSI.h}}
...
\label{libSSI_8h_1cf7f1865b83c4db022c1dccc92bb494}
...
\hypertarget{libSSI_8h_b06e5daae7a5fd90d47d8cc7e1d5e32f}{
\index{libSSI.h@{lib\-SSI.h}!libSSI_parse_obs_created@{libSSI\_\-parse\_\-obs\_\-created}}
\index{libSSI_parse_obs_created@{libSSI\_\-parse\_\-obs\_\-created}!libSSI.h@{lib\-SSI.h}}
...
\label{libSSI_8h_b06e5daae7a5fd90d47d8cc7e1d5e32f}
...
\hypertarget{libSSI_8h_6bf19d62c9f06e867f374679daeb6e9d}{
\index{libSSI.h@{lib\-SSI.h}!libSSI_parse_obs_finished@{libSSI\_\-parse\_\-obs\_\-finished}}
\index{libSSI_parse_obs_finished@{libSSI\_\-parse\_\-obs\_\-finished}!libSSI.h@{lib\-SSI.h}}
...
\label{libSSI_8h_6bf19d62c9f06e867f374679daeb6e9d}
...
\begin{Desc}
\item[Returns:]1 on success, -1 on failure \end{Desc}
\hypertarget{libSSI_8h_e999b15a2e684c22572024514984f1d8}{
\index{libSSI.h@{lib\-SSI.h}!libSSI_sensor_discovery@{libSSI\_\-sensor\_\-discovery}}
\index{libSSI_sensor_discovery@{libSSI\_\-sensor\_\-discovery}!libSSI.h@{lib\-SSI.h}}
...
\label{libSSI_8h_e999b15a2e684c22572024514984f1d8}
